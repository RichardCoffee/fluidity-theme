...
#		}
		...
		if ( empty( $this->placeholder ) ) {
			if ( empty( $this->description ) ) {
				$this->placeholder = ( $this->required ) ? __( 'Required Field', 'tcc-fluid' ) : '';
			} else {
				$this->placeholder = $this->description . ( ( $this->required ) ? ( ' ' . __( '(required field)', 'tcc-fluid' ) ) : '' );
			}
		}
		if ( empty( $this->id ) ) {
			$this->id = $this->name;
		...
		if ( $this->required ) {
			if ( empty( $this->title ) ) {
				$this->title = __( 'Required Field', 'tcc-fluid' );
			} else {
				$this->title .= ' ' . __( '(required field)', 'tcc-fluid' );
			}
		}
