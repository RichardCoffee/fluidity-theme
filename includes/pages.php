...
if (!function_exists('fluid_category_page_noposts')) {
  function fluid_category_page_noposts() { ?>
    <div id="post-0" class="post error404 not-found">
      <h1 class="text-center"><?php _e('Not Found','tcc-fluid' ); ?></h1>
      <p><?php
        _e( 'Apologies, but no results were found for the requested Category. Perhaps searching will help find a related post.','tcc-fluid' ); ?>
      </p><?php
      get_search_form(); ?>
    </div><!-- #post-0 --><?php
  }
...
if (!function_exists('fluid_search_page_noposts')) {
  function fluid_search_page_noposts() { ?>
    <div id="post-0" class="post error404 not-found">
      <h1 class="text-center"><?php _e('Not Found','tcc-fluid' ); ?></h1>
      <p><?php
        _e( 'Apologies, but no results were found for the requested search. Perhaps searching with alternate keyword(s) will help.','tcc-fluid' ); ?>
      </p><?php
      get_search_form(); ?>
    </div><!-- #post-0 --><?php
  }
