...
<div id="fluid-header" class="<?php echo container_type('fluid-header'); ?>" <?php $micro->Header(); ?> role="banner"><?php

  if (has_action('tcc_header_top_menubar')) { ?>
    <div id="header-topmenu" class="navbar navbar-<?php echo $color_scheme; ?>" <?php $micro->Navigation(); ?> role="navigation"><?php
  ...
  if (has_action('tcc_header_bottom_menubar')) { ?>
    <div id="header-menubar" class="navbar navbar-<?php echo $color_scheme; ?>" <?php $micro->Navigation(); ?> role="navigation"><?php
